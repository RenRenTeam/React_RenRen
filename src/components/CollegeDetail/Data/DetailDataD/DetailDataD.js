                    ...
                    <div className="college-box">
                        <div id="div_university" className="info">
                            ...
                            <div className="description">
                                <div className="desc">学校类型：<span className="type">{this.props.json.ClassesStr}</span></div>
                                <div className="other">
                                    <div className="like">{this.props.json.Browses}</div>
                                    <div className="position">{this.props.json.PositionStr}</div>
