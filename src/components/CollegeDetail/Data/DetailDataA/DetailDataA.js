                    ...
                    <div className="college-box">
                        <div id="div_university" className="info">
                            <div className="logo-box">
                                <div className="logo">
                                    <img src={this.props.json.DefaultLogoUrl} />
                                </div>
                                <div className="text">
                            ...
                            <div className="description">
                                <div className="desc">学校类型：<span className="type">{this.props.json.SchoolNature}</span>建校时间：<span>{this.props.json.Buildtime}</span></div>
                                <div className="other">
                                    <div className="like">{this.props.json.Follow}</div>
