...
class Banner {
                ...
                <div id="da-slider" className="slideshow da-slider">
                        <CSlider {...settings}>
                            <div className="da-slide usa-banner1">
                                <h2>
                                    <img src="http://new.rrliuxue.com/WebResources/Default/images/banner/USA/statue-of-liberty.png" /></h2>
                                <div className="da-img">
                                    <img src="http://new.rrliuxue.com/WebResources/Default/images/banner/USA/text.png" />
                                </div>
                            </div>
                            <div className="da-slide usa-banner1">
                                <h2>
                    ...
                    <div id="planForm">
                        ...
                        <div className="bottom">
                            ...
                            <div className="message">
                                已有<span>2036</span>位小伙伴加入<br />
                                人人留学, <a href="/register.aspx">我要加入</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    handleGoRequest(){
        ...
        AppActions.navigateTo("/StudySolution_USA_" + time + "_" + grade);
      }
}
