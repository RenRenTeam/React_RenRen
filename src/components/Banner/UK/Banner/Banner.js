...
class Banner {
        ...
        return (
            <section className="banner">
                <div id="da-slider" className="slideshow da-slider">
                    <CSlider {...settings}>
                        <div className="da-slide uk-banner1" data-bg="url(WebResources/Default/images/banner/UK/bg.png) no-repeat center top #f7f0e4">
                            <h2>
                                <img src="http://new.rrliuxue.com/WebResources/Default/images/banner/UK/BIG-BEN.png" /></h2>
                            <p>
                                <img src="http://new.rrliuxue.com/WebResources/Default/images/banner/UK/kid.png" /></p>
                            <div className="da-img">
                                <img src="http://new.rrliuxue.com/WebResources/Default/images/banner/UK/2015.png" /></div>
                        </div>
                        <div className="da-slide uk-banner1" data-bg="url(WebResources/Default/images/banner/UK/bg.png) no-repeat center top #f7f0e4">
                            <h2>
                                <img src="http://new.rrliuxue.com/WebResources/Default/images/banner/UK/BIG-BEN.png" /></h2>
                ...
                <div className="plan-box">
                    <div id="planForm">
                        ...
                        <ul>
                            ...
                            <li>
                                <button className="btn-plan" onClick={this.handleGoRequest}>获取留学方案</button>
                            </li>
                        </ul>
    ...
    handleGoRequest(){
        var time = $("#selectO .rc-select-selection__rendered").children().eq(0).html();
        var grade = $("#select1 .rc-select-selection__rendered").children().eq(0).html();
        var country = $(".country .active").attr("data-country");
