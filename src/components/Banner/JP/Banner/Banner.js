        ...
        return (
            <section className="banner">
                <div id="da-slider" className="slideshow da-slider">
                    <CSlider {...settings}>
                        <div className="da-slide jp-banner1" data-bg="url(WebResources/Default/images/banner/JP/bg.jpg) no-repeat center top #f6d042">
                            <h2>
                                <img src="http://new.rrliuxue.com/WebResources/Default/images/banner/JP/text.png" /></h2>
