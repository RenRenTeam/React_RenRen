...
class OpenClassUK{
    render() {
        return (
            <div className="content" id="ukClass">
                <div className="first-box">
                    ...
                    <div className="new-class">
                        ...
                        <div className="class-desc">
                            ...
                            <div className="detail"><a href="/open-class-detail.aspx">即将开课UK ></a></div>
                            <div className="clear"></div>
                        </div>
                    </div>
                        ...
                        <div className="evaluation-list">
                            <div className="evaluation-item">
                                <div className="head-pic">
                                    <img className="echoImg" src="http://new.rrliuxue.com/WebResources/Default/images/echo/blank.gif" data-echo="http://new.rrliuxue.com/WebResources/Default/images/open-class/head-pic1.png"/>
                                </div>
                                <div className="evaluation-info">
                                    <div className="student-name">Cidy</div>
                                    <div className="class-name"><a href="#">气候模式及预测UK</a></div>
                                </div>
                                <div className="clear"></div>
                            ...
                            <div className="evaluation-item">
                                <div className="head-pic">
                                    <img src="http://new.rrliuxue.com/WebResources/Default/images/echo/blank.gif" />
                                </div>
                                <div className="evaluation-info">
                    ...
                    <div className="class-list">
                        <div className="class-item">
                            <div className="class-pic">
                                <a href="/open-class-detail.aspx">
                                    <img src="http://new.rrliuxue.com/WebResources/Default/images/open-class/1.jpg"/></a>
                            </div>
                            <div className="class-desc">
                        ...
                        <div className="class-item">
                            <div className="class-pic">
                                <a href="/open-class-detail.aspx">
                                    <img src="http://new.rrliuxue.com/WebResources/Default/images/open-class/2.jpg"/></a>
                            </div>
                            <div className="class-desc">
                                <h1><a href="/open-class-detail.aspx">课程名称</a></h1>
                        ...
                        <div className="class-item">
                            <div className="class-pic">
                                <a href="/open-class-detail.aspx">
                                    <img src="http://new.rrliuxue.com/WebResources/Default/images/open-class/3.jpg"/></a>
                            </div>
                            <div className="class-desc">
                                <h1><a href="/open-class-detail.aspx">课程名称</a></h1>
