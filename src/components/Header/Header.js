              ...
              <div className="header-box">
                ...
                <div className="menu-box">
                  <ul className="menu" id="menu">
                    <li className=""><a className="home-menu" href="/Index" onClick={Link.handleClick}></a><div className="bg"></div></li>
                    ...
                    <li><a className="news-menu" href="/AdvisoryLibrary" onClick={Link.handleClick}></a><div className="bg"></div></li>
                    <li><a className="college-menu" href="/College" onClick={Link.handleClick}></a><div className="bg"></div></li>
